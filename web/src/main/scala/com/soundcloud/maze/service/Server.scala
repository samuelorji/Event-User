...
//import com.soundcloud.maze.actors.MessageDispatcherActor
...
//
//  val dispatcher = system.actorOf(Props(new MessageDispatcherActor()))
//  val eventSocketService = system.actorOf(Props(new EventSocketService(dispatcher)),"event-socket-service")
//  val userSocketService  = system.actorOf(Props(new UserSocketService(dispatcher)), "user-socket-service")
//
//  IO(Tcp) ! Tcp.Bind(
//    eventSocketService,
